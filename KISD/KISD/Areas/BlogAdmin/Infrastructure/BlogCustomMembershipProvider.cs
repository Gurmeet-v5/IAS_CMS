...
namespace KISD.Areas.BlogAdmin.Infrastructure
{
    public class BlogCustomMembershipProvider:MembershipProvider
    {
        /// <summary>
        ...
        public override MembershipUser CreateUser(string username, string password, string email, string passwordQuestion, string passwordAnswer, bool isApproved, object providerUserKey, out MembershipCreateStatus status)
        {
            ...
            if (user == null)
            {
                var userObj = new UsersModel { UserNameTxt = username, Password = GetMd5Hash(password), EmailTxt = email };
        ...
        public override void UpdateUser(MembershipUser user)
        {
            ...
            db_KISDEntities objContext = new db_KISDEntities();
            var objuser = objContext.Users.Find(user.ProviderUserKey);
