...
$(document).ready(function (e) {
    ...
    //This function disable certain special characters in texbox
    $('.disableSpecialChar').bind('keypress', function (event) {
        var charcode = event.keyCode ? event.keyCode : event.which
        if (charcode == 60 || charcode == 62 || charcode == 123 || charcode == 125 || charcode == 91 || charcode == 93) {
            return false;
        }
    });
});
