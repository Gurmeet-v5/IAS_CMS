...
namespace KISD.Areas.Admin.Models
{
    ...
    public enum ContentType : int
    {
        ...
        NewToKISDMenu = 19,
        NewToKISDSubMenu = 20,
        ParentStudentsMenu = 21,
        ParentStudentsSubMenu = 22,
        DepartmentsMenu = 23,
        DepartmentsSubMenu = 24,
        Fly = 25,
        SchoolBoardMenu = 26,
        SchoolBoardSubMenu = 27,
        EmploymentMenu = 28,
        EmploymentSubMenu = 29,
        Search = 30,
        ContactUs = 31,
        HomeRightSection = 32,
        ExceptionalOpportunities = 33,
        BoardMembers = 34,
        Staff = 35,
        News = 36,
        Events = 37,
